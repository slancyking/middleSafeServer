...
#define WEBAPI_LOGIN "/api/app/card/login"									//登陆

#define WEBAPI_SETTITLE "/api/app/card/set-title"									//登陆
#define WEBAPI_LOGOUT "/api/app/card/logout"								//登出
#define WEBAPI_PING "/api/app/card/ping"									//心跳
#define WEBAPI_PAUSE  "/api/app/card/pause"									//计时暂停
#define WEBAPI_NORMALREPORT "/api/app/middle-report/normal-report"			//中间件报告
#define WEBAPI_NormalQuery "/api/app/middle-report/normal-query"			//中间件查询
#define WEBAPI_TRYUSEIP "/api/app/ip-log/try-use-ip"						//尝试使用ip
#define WEBAPI_NAMECOLLECT "/api/app/name-collect/many"						//名字信息收集,多实体
#define WEBAPI_NAMEINFORANDOM "/api/app/name-collect/random-name-collect"	//随机一个信息
#define WEBAPI_ERRORCOLLECT "/api/app/error-collect/client-error-collect"	//异常收集
#define WEBAPI_PROPCOLLECT "/api/app/prop-collection/sync"					//创建物品收集
