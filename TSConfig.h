...
#define  __开启加密模式__			FALSE     //部署 VMP 壳子, 暗桩. 调试检测 等

#define  __开启图色模式__			FALSE     //是否开启大漠的调试功能



//注意: 需注意对开数目限制

#define CMD服务起始端口号           15400				//脚本端的 通讯端口号
#define NET服务起始端口号           15500				//调试器端, 接收封包数据的端口号


#define  特征_脚本调试主窗口特征   0x6A0F2E0F    
#define  特征_主控制台主窗口特征   0x7A0F21A1    
#define  特征_挂机脚本主窗口特征   0x5A1F0E0F  





//记录 当前进程名称   禁止外部更新的, 如果更改 那么程序无法正常获取主路径等信息
#define 模块_控制台主程序                "ConsoleModel.exe"  

#define 模块_答题插件主程序              "CodesAnswer.exe"  

#define 模块_守护进程主服务              "in.dll"

#define 模块_守护进程主程序              "TSDebugModel.exe"

#define 模块_STeam游戏主程序             "ProjectLH.exe"  
...
//公用的 日志文件, 全部日志信息为异常日志
#define STR_MAINLOGFILENAME           "MainLog.log" 


#define key_Script                      "执行脚本"
#define key_EConfig                     "扩展配置"
#define key_RStatus                     "当前状态"
#define key_DebugLOG                    "输出记录"
#define key_Enable					    "启用状态"

#pragma region//---------------------------------------------------------------------------------------------默认颜色值 的宏定义, 定义了大部分常用颜色表
