...
{
    [DbContext(typeof(middleSafeServerDbContext))]
    [Migration("20221116034611_Created_ErrorCollect_Entity")]
    partial class Created_ErrorCollect_Entity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("middleSafeServer.SK.Branchs.Branch", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("middleSafeServer.SK.CardMsgs.CardMsg", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CardMsgs", (string)null);
                });

            modelBuilder.Entity("middleSafeServer.SK.Cards.Card", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("EnableMail")
                        .HasColumnType("bit");

                    b.Property<bool>("EnablePhoneMsg")
                        .HasColumnType("bit");
                    ...
                    b.Property<DateTime>("LoginOvertime")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("middleSafeServer.SK.ErrorCollects.ErrorCollect", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("BackStackTraceBack")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("ErrorCollects", (string)null);
                });

            modelBuilder.Entity("middleSafeServer.SK.InfoAgents.InfoAgent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("InfoAgents", (string)null);
                });

            modelBuilder.Entity("middleSafeServer.SK.InfoCollects.ImageCollects.ImageCollect", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<long>("Image64Size")
                        .HasColumnType("bigint");

                    b.Property<string>("ImageBase64")
                        .HasColumnType("nvarchar(max)");

                    b.Property<long>("ImageHash")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("InfoAgentId");

                    b.ToTable("ImageCollects", (string)null);
                });

            modelBuilder.Entity("middleSafeServer.SK.InfoCollects.NameCollectCounts.NameCollectCount", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("NameCollectCounts", (string)null);
                });

            modelBuilder.Entity("middleSafeServer.SK.InfoCollects.NameCollects.NameCollect", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<long>("CollectIndex")
                        .HasColumnType("bigint");
                    ...
                    b.Property<bool>("FinishSaveHeadIcon")
                        .HasColumnType("bit");

                    b.Property<string>("HeadIconUrl")
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid?>("ImageCollectId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<long>("NameHash")
                        .HasColumnType("bigint");

                    b.Property<int>("RetrySaveHeadIconCount")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ImageCollectId");

                    b.HasIndex("InfoAgentId");

                    b.ToTable("NameCollects", (string)null);
                });

            modelBuilder.Entity("middleSafeServer.SK.InputForms.InputForm", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("middleSafeServer.SK.MiddleReports.MiddleReport", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("PostUnix")
                        .HasColumnType("int");

                    b.Property<string>("RandomKey")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("RandomPort")
                        .HasColumnType("int");
                    ...
                    b.ToTable("MiddleReports", (string)null);
                });

            modelBuilder.Entity("middleSafeServer.SK.NetworkAddressPool.IpLogs.IpLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("IpLogs", (string)null);
                });

            modelBuilder.Entity("middleSafeServer.SK.Projects.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("middleSafeServer.SK.PropCollects.PropCollect", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PropCollects", (string)null);
                });

            modelBuilder.Entity("middleSafeServer.SK.WebSettings.WebSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool>("IsMailReportDrop")
                        .HasColumnType("bit");

                    b.Property<bool>("IsMailReportServiceResource")
                        .HasColumnType("bit");

                    b.Property<bool>("IsSmsReportDrop")
                        .HasColumnType("bit");

                    b.Property<bool>("IsSmsReportServiceResource")
                        .HasColumnType("bit");

                    b.Property<string>("MailListForServiceResource")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PhoneNumForServiceResource")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("middleSafeServer.SK.Branchs.Branch", b =>
                {
                    b.HasOne("middleSafeServer.SK.Projects.Project", null)
                        .WithMany()
            ...
            modelBuilder.Entity("middleSafeServer.SK.ErrorCollects.ErrorCollect", b =>
                {
                    b.HasOne("middleSafeServer.SK.Branchs.Branch", null)
                        .WithMany()
                        .HasForeignKey("BranchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("middleSafeServer.SK.Cards.Card", null)
                        .WithMany()
            ...
            modelBuilder.Entity("middleSafeServer.SK.InfoCollects.ImageCollects.ImageCollect", b =>
                {
                    b.HasOne("middleSafeServer.SK.InfoAgents.InfoAgent", null)
                        .WithMany()
                        .HasForeignKey("InfoAgentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("middleSafeServer.SK.InfoCollects.NameCollects.NameCollect", b =>
                {
                    b.HasOne("middleSafeServer.SK.InfoCollects.ImageCollects.ImageCollect", null)
                        .WithMany()
                        .HasForeignKey("ImageCollectId");
