    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CardMsgs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoginOvertime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LoginToken = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RsaPrivateKey = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    ChargingMode = table.Column<int>(type: "int", nullable: false),
                    ExpiredTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SurplusSecond = table.Column<long>(type: "bigint", nullable: false),
                    ...
                    EnableMail = table.Column<bool>(type: "bit", nullable: false),
                    EnablePhoneMsg = table.Column<bool>(type: "bit", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InfoAgents", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InputForms", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    IpMaxUserCount = table.Column<int>(type: "int", nullable: false),
                    Remark = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CardId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PropName = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    PropId = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    PropNum = table.Column<int>(type: "int", nullable: false),
                    PostUnix = table.Column<int>(type: "int", nullable: false),
                    Remark = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropCollects", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IsMailReportDrop = table.Column<bool>(type: "bit", nullable: false),
                    IsMailReportServiceResource = table.Column<bool>(type: "bit", nullable: false),
                    MailListForServiceResource = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsSmsReportDrop = table.Column<bool>(type: "bit", nullable: false),
                    IsSmsReportServiceResource = table.Column<bool>(type: "bit", nullable: false),
                    PhoneNumForServiceResource = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RandomPort = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MiddleReports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MiddleReports_Cards_CardId",
                        column: x => x.CardId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    InfoAgentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ImageBase64 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Image64Size = table.Column<long>(type: "bigint", nullable: false),
                    ImageMd5 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ImageHash = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImageCollects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ImageCollects_InfoAgents_InfoAgentId",
                        column: x => x.InfoAgentId,
                        principalTable: "InfoAgents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "NameCollectCounts",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NameCollectCounts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NameCollectCounts_InfoAgents_InfoAgentId",
                        column: x => x.InfoAgentId,
                        principalTable: "InfoAgents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Branchs_Projects_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CardId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProjectId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LogMark = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IpLogs_Cards_CardId",
                        column: x => x.CardId,
                        principalTable: "Cards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IpLogs_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameHash = table.Column<long>(type: "bigint", nullable: false),
                    FinishSaveHeadIcon = table.Column<bool>(type: "bit", nullable: false),
                    HeadIconUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RetrySaveHeadIconCount = table.Column<int>(type: "int", nullable: false),
                    ImageCollectId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CollectIndex = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NameCollects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NameCollects_ImageCollects_ImageCollectId",
                        column: x => x.ImageCollectId,
                        principalTable: "ImageCollects",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_NameCollects_InfoAgents_InfoAgentId",
                        column: x => x.InfoAgentId,
                        principalTable: "InfoAgents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImageCollects_InfoAgentId",
                table: "ImageCollects",
                column: "InfoAgentId");

            migrationBuilder.CreateIndex(
                name: "IX_IpLogs_CardId",
                table: "IpLogs",
                column: "CardId");

            migrationBuilder.CreateIndex(
                name: "IX_IpLogs_ProjectId",
                table: "IpLogs",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_MiddleReports_CardId",
                table: "MiddleReports",
                column: "CardId");

            migrationBuilder.CreateIndex(
                name: "IX_NameCollectCounts_InfoAgentId",
                table: "NameCollectCounts",
                column: "InfoAgentId");

            migrationBuilder.CreateIndex(
                name: "IX_NameCollects_ImageCollectId",
                table: "NameCollects",
                column: "ImageCollectId");

            migrationBuilder.CreateIndex(
                name: "IX_NameCollects_InfoAgentId",
                table: "NameCollects",
                column: "InfoAgentId");
